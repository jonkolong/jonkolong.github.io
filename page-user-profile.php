    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="User Profile"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-4 order-last">
                  <ul
                    ...
                    <li><button class="btn btn-primary text-nowrap">Add To Story</button></li>
                  </ul>
                </div>
              </div>
              <ul
                class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-primary-subtle rounded-2 rounded-top-0"
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link hstack gap-2 rounded-0 py-6" id="pills-followers-tab"
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link hstack gap-2 rounded-0 py-6" id="pills-friends-tab"
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <div class="hstack align-self-center gap-3">
                          <div class="hstack gap-6">
                              <a class="p-0 hstack justify-content-center round-32 btn btn-primary rounded-circle"
                              href="javascript:void(0)">
                          ...
                          <div class="hstack gap-6">
                              <a class="hstack p-0 round-32 justify-content-center btn btn-secondary rounded-circle"
                              href="javascript:void(0)">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle" width="40"
                          height="40">
                        <h6 class="mb-0">Mathew Anderson</h6>
                        <span class="fs-2 hstack gap-2"><span class="round-10 text-bg-light rounded-circle d-inline-block"></span> 15 min
                          ago</span>
                      </div>
                      ...
                      <img src="assets/images/products/s1.jpg" alt="modernize-img" height="360"
                      ...
                      <div class="position-relative">
                        <div class="p-4 rounded-4 text-bg-light mb-3">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="rounded-circle"
                              width="33" height="33">
                            <h6 class="mb-0">Deran Mac</h6>
                            <span class="fs-2"><span class="p-1 text-bg-muted rounded-circle d-inline-block"></span> 8 min ago</span>
                          </div>
                        ...
                        <div class="p-4 rounded-4 text-bg-light mb-3">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="assets/images/profile/user-4.jpg" alt="modernize-img" class="rounded-circle"
                              width="33" height="33">
                            <h6 class="mb-0">Daisy Wilson</h6>
                            <span class="fs-2"><span class="p-1 text-bg-muted rounded-circle d-inline-block"></span> 5
                              min
                              ago</span>
                          </div>
                          <p class="my-3">
                        ...
                        <div class="p-4 rounded-2 text-bg-light ms-7">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="assets/images/profile/user-5.jpg" alt="modernize-img" class="rounded-circle"
                              width="40" height="40">
                    ...
                    <div class="d-flex align-items-center gap-6 flex-wrap p-3 flex-lg-nowrap">
                      <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle" width="33"
                        height="33">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="assets/images/profile/user-5.jpg" alt="modernize-img" class="rounded-circle" width="40"
                          height="40">
                        <h6 class="mb-0">Carry Minati</h6>
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="assets/images/profile/user-2.jpg" alt="modernize-img" class="rounded-circle" width="40"
                          height="40">
                        <h6 class="mb-0">Genelia Desouza</h6>
                        <span class="fs-2"><span class="p-1 text-bg-light rounded-circle d-inline-block"></span> 15 min
                          ago</span>
                      </div>
                      <p class="text-dark my-3">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <img src="assets/images/products/s2.jpg" alt="modernize-img"
                      ...
                      <div class="p-4 rounded-4 text-bg-light">
                        <div class="d-flex align-items-center gap-6 flex-wrap">
                          <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="rounded-circle" width="33"
                            height="33">
                          <h6 class="mb-0">Ritesh Deshmukh</h6>
                          <span class="fs-2"><span class="p-1 text-bg-muted rounded-circle d-inline-block"></span> 15
                            min
                            ago</span>
                        </div>
                        <p class="my-3">
                    ...
                    <div class="d-flex align-items-center gap-6 flex-wrap p-3 flex-lg-nowrap">
                      <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle" width="33"
                        height="33">
                      <input type="text" class="form-control py-8" id="exampleInputtext2" aria-describedby="textHelp"
                        placeholder="Comment">
                      <button class="btn btn-primary">Comment</button>
                    </div>
                  </div>
                  <div class="card">
                    <div class="card-body border-bottom">
                      ...
                      <iframe class="rounded-4 border border-2 mb-3 h-300"
                        src="https://www.youtube.com/embed/d1-FRj20WBE" frameborder="0" width="100%"></iframe>
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center gap-2">
                          <a class="round-32 rounded-circle btn btn-primary p-0 hstack justify-content-center"
                            href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="d-flex align-items-center gap-6 flex-wrap p-3 flex-lg-nowrap">
                      <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle" width="33"
                        height="33">
                      <input type="text" class="form-control py-8" id="exampleInputtext3" aria-describedby="textHelp"
                        placeholder="Comment">
                      <button class="btn btn-primary">Comment</button>
                    </div>
                  </div>
            ...
            <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab"
              ...
              <div class="row">
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-4.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-6.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-7.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                        <h5 class="fw-semibold mb-0">Barton</h5>
                        <span class="fs-2 d-flex align-items-center"><i
                            class="ti ti-map-pin text-dark fs-3 me-1"></i>French Souther</span>
                      </div>
                      <button class="btn btn-outline-primary py-1 px-2 ms-auto">Follow</button>
                    </div>
                  </div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-8.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-9.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="assets/images/profile/user-10.jpg" alt="modernize-img" class="rounded-circle" width="40"
                        height="40">
                      <div>
            ...
            <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab"
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                      <h5 class="fw-semibold mb-0">Betty Adams</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-2.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-4.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-5.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-6.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-7.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-8.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-9.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="assets/images/profile/user-10.jpg" alt="modernize-img" class="rounded-circle mb-3"
                        width="80" height="80">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s1.jpg" alt="modernize-img" height="220"
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s2.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s3.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s4.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s5.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s6.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s7.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s8.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s9.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s10.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s11.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="assets/images/products/s12.jpg" alt="modernize-img" height="220"
                        class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
