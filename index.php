  ...
  <div class="toast toast-onload align-items-center text-bg-primary border-0" role="alert" aria-live="assertive"
    ...
    <div class="toast-body hstack align-items-start gap-6">
      ...
      <div>
        ...
        <h6 class="text-white fs-2 mb-0">Ayo berkolaborasi</h6>
      </div>
          ...
          <div class="owl-carousel counter-carousel owl-theme">
              ...
              <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/data-center.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="datacenter-img" />
                    <p class="fw-semibold fs-3 text-info mb-1">Pusat Data</p>
                    <h5 class="fw-semibold text-info mb-0">35</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/cctv.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="cctv-img" />
                    <p class="fw-semibold fs-3 text-danger mb-1">CCTV</p>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/app-development.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="app-img" />
                    <p class="fw-semibold fs-3 text-warning mb-1">Aplikasi</p>
                    <h5 class="fw-semibold text-warning mb-0">36</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/time-management.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="reserve-img" />
                    <p class="fw-semibold fs-3 text-danger mb-1">Reservasi</p>
                    <h5 class="fw-semibold text-danger mb-0">6</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/webinar.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="meeting-img" />
                    <p class="fw-semibold fs-3 text-info mb-1">Virtual meeting</p>
                    <h5 class="fw-semibold text-info mb-0">4</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-success-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/signature.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="sign-img" />
                    <p class="fw-semibold fs-3 text-success mb-1">TTE</p>
                    <h5 class="fw-semibold text-success mb-0">18</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/pngs/wifi.png" class="mb-3 d-inline"
                      style="width:50px;height:50px;" alt="wifi-img" />
                    <p class="fw-semibold fs-3 text-info mb-1">Jaringan</p>
                    <h5 class="fw-semibold text-info mb-0">100</h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-7 pb-2">
                    <div class="me-3 pe-1">
                      <img src="assets/images/profile/user-2.jpg" class="shadow-warning rounded-2" alt="modernize-img"
                        width="72" height="72" />
                    </div>
                    <div>
