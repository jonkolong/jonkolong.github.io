    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Banner"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      <img src="assets/images/backgrounds/website-under-construction.svg" alt="modernize-img"
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      <img src="assets/images/products/empty-shopping-bag.gif" alt="modernize-img" class="img-fluid mb-4"
                        width="200">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body text-center">
                  <p>LEVEL UP</p>
                  <img src="assets/images/backgrounds/gold.png" alt="modernize-img" class="img-fluid mb-4" width="150">
