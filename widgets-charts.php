    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Charts"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <div class="row">
                ...
                <div class="card-body pb-4">
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="p-2 bg-primary-subtle rounded-1 d-inline-block">
                      <img src="assets/images/svgs/icon-master-card-2.svg" alt="matdash-img" class="img-fluid" width="24"
                        height="24">
                    </div>
                  </div>
                  <div class="d-flex align-items-center mb-7 pb-8">
