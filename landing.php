        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav align-items-center mb-2 mb-lg-0 ms-auto">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="dark/index2.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="horizontal/index3.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="minisidebar/index4.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="rtl/index5.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                      ...
                      <div class="row justify-content-between">
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="app-calendar.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="app-chat.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="app-email.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="app-contact2.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                        ...
                        <div class="col">
                          <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                            ...
                            <a target="_blank" href="app-invoice.php"
                              class="btn btn-primary lp-demos-btn fs-2 p-1 rounded position-absolute top-50 start-50 translate-middle">Live
                              Preview</a>
                          </div>
                          <h6 class="mb-0 text-center fw-bolder fs-3">
                      ...
                      <div class="p-4">
                        <div>
                          <div class="row">
                              ...
                              <div class="position-relative">
                                <a target="_blank" href="app-chat.php"
                                  ...
                                  <div
                                    ...
                                    <img src="assets/images/svgs/icon-dd-chat.svg" alt="modernize-img" class="img-fluid"
                                      width="24" height="24" />
                                  </div>
                                  <div>
                                ...
                                <a target="_blank" href="app-email.php"
                                  ...
                                  <div
                                    class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                    <img src="assets/images/svgs/icon-dd-message-box.svg" alt="modernize-img"
                            ...
                            <div class="col-6">
                              <div class="position-relative">
                                <a target="_blank" href="page-user-profile.php"
                                  class="d-flex align-items-center pb-9 position-relative lh-base">
                                  <div
                                    class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                    <img src="assets/images/svgs/icon-dd-cart.svg" alt="modernize-img" class="img-fluid"
                                      width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="mb-1 fw-semibold text-hover-primary">
                                ...
                                <a target="_blank" href="app-calendar.php"
                                  ...
                                  <div
                                    class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                    <img src="assets/images/svgs/icon-dd-date.svg" alt="modernize-img" class="img-fluid"
                                      width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="mb-1 fw-semibold text-hover-primary">
                                ...
                                <a target="_blank" href="app-contact.php"
                                  class="d-flex align-items-center pb-9 position-relative lh-base">
                                  <div
                                    class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                ...
                                <a target="_blank" href="app-notes.php"
                                  class="d-flex align-items-center pb-9 position-relative lh-base">
                                  <div
                                    class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                    <img src="assets/images/svgs/icon-dd-application.svg" alt="modernize-img"
                                      class="img-fluid" width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="mb-1 fw-semibold text-hover-primary">
                        ...
                        <ul class="list-unstyled">
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                              href="page-pricing.php">Pricing Page</a>
                          </li>
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                              href="authentication-login.php">Authentication Design</a>
                          </li>
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                              href="authentication-register.php">Register Now</a>
                          </li>
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                              href="authentication-error.php">404 Error Page</a>
                          </li>
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                          ...
                          <li class="mb-3">
                            <a class="fw-semibold text-dark text-hover-primary" target="_blank"
                              href="page-account-settings.php">Account Settings</a>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="docs/index.php"
              ...
              <li class="nav-item ms-2">
                <a class="btn btn-primary fs-3 rounded btn-hover-shadow px-3 py-2"
                  href="authentication-login.php">Login</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
              <div class="d-sm-flex align-items-center text-center gap-2 justify-content-center mb-7">
                <ul
                  ...
                  <li class="ms-n2">
                    <a class="d-block" href="javascript:void(0)">
                      <img src="assets/images/profile/user-2.jpg" alt="modernize-img"
                        class="img-fluid border border-2 rounded-circle border-white" width="32" height="32" />
                    </a>
                  </li>
                  <li class="ms-n2">
          ...
          <div class="domo-contect position-relative">
            ...
            <div class="demos-view mt-4">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="assets/images/apps/modernize-bt-app-contact-list.jpg" alt="modernize-img"
                      class="img-fluid" />
                    <a target="_blank" href="app-contact.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    ...
                    <a target="_blank" href="blog-posts.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="assets/images/apps/modernize-vue-app-blog-detail.jpg" alt="modernize-img"
                      class="img-fluid" />
                    <a target="_blank" href="blog-detail.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    ...
                    <a target="_blank" href="eco-shop.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    ...
                    <a target="_blank" href="eco-shop-detail.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    ...
                    <a target="_blank" href="eco-product-list.php"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                  ...
                  <div class="card-body p-4">
                    <div class="d-flex justify-content-between mb-4">
                      <div class="d-flex align-items-center">
                        <img src="assets/images/profile/user-1.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle"
                          width="40" height="40" />
                        <div>
              ...
              <div class="item">
                <div class="card">
                  <div class="card-body p-4">
                    <div class="d-flex justify-content-between mb-4">
                      <div class="d-flex align-items-center">
                        <img src="assets/images/profile/user-2.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle"
                          width="40" height="40" />
                        <div>
              ...
              <div class="item">
                <div class="card">
                  <div class="card-body p-4">
                    <div class="d-flex justify-content-between mb-4">
                      <div class="d-flex align-items-center">
                        <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="w-auto me-3 rounded-circle"
                          width="40" height="40" />
                        <div>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-lg-5 col-xl-5">
              <div class="text-center text-lg-end">
                <img src="assets/images/backgrounds/business-woman-checking-her-mail.png" alt="modernize-img"
                  class="img-fluid" />
              </div>
            </div>
          </div>
    ...
    <div class="offcanvas offcanvas-start modernize-lp-offcanvas" tabindex="-1" id="offcanvasNavbar"
      ...
      <div class="offcanvas-body p-4">
        <ul class="navbar-nav justify-content-end flex-grow-1">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu ps-2">
              <li>
                <a class="dropdown-item text-dark" href="./index.php">Dark</a>
              </li>
              <li>
                <a class="dropdown-item text-dark" href="./index.php">Horizontal</a>
              </li>
              <li>
                <a class="dropdown-item text-dark" href="./index.php">LTR</a>
              </li>
              <li>
                <a class="dropdown-item text-dark" href="./index.php">Minisidebar</a>
              </li>
              <li>
                <a class="dropdown-item text-dark" href="./index.php">RTL</a>
              </li>
            </ul>
          </li>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="position-relative">
                    ...
                    <a href="javascript:void(0)" class="d-flex align-items-center pb-9 position-relative lh-base">
                      <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                        <img src="assets/images/svgs/icon-dd-invoice.svg" alt="modernize-img" class="img-fluid" width="24"
                          height="24" />
                      </div>
                      <div>
                        <h6 class="mb-1 fw-semibold text-hover-primary">
                    ...
                    <a href="javascript:void(0)" class="d-flex align-items-center pb-9 position-relative lh-base">
                      <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                        <img src="assets/images/svgs/icon-dd-mobile.svg" alt="modernize-img" class="img-fluid" width="24"
                          height="24" />
                      </div>
                      <div>
                        <h6 class="mb-1 fw-semibold text-hover-primary">
                ...
                <div class="col-12">
                  <div class="position-relative">
                    ...
                    <a href="javascript:void(0)" class="d-flex align-items-center pb-9 position-relative lh-base">
                      <div class="text-bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                        <img src="assets/images/svgs/icon-dd-lifebuoy.svg" alt="modernize-img" class="img-fluid" width="24"
                          height="24" />
                      </div>
                      <div>
                        <h6 class="mb-1 fw-semibold text-hover-primary">
          ...
          <li class="nav-item mt-3">
            <a class="nav-link fs-3 text-dark active" aria-current="page" href="../docs/index.php">Documentation</a>
          </li>
          <li class="nav-item mt-3">
        ...
        <form class="d-flex mt-3" role="search">
          <a href="authentication-login.php" class="btn btn-primary w-100 py-2">Login</a>
        </form>
      </div>
    </div>
  </div>
