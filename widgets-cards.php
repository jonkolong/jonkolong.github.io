    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Cards"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
         
          <div class="row">
            <div class="col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="assets/images/blog/blog-img1.jpg"
            ...
            <div class="col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="assets/images/blog/blog-img2.jpg"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
            ...
            <div class="col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="assets/images/blog/blog-img3.jpg"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="assets/images/blog/blog-img5.jpg" class="w-100 h-100 rounded-0" alt="modernize-img">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="assets/images/blog/blog-img4.jpg" class="w-100 h-100 rounded-0" alt="modernize-img">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="assets/images/blog/blog-img3.jpg" class="w-100 h-100 rounded-0" alt="modernize-img">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="assets/images/profile/user-11.jpg" alt="modernize-img" class="img-fluid rounded-circle mb-4"
                    width="80" height="80">
                  <h4 class="card-title">Andrew Grant</h4>
                  <div class="d-flex align-items-center gap-4 mb-4">
                    <div class="d-flex align-items-center">
                      <a href="javascript:void(0)">
                        <img src="assets/images/profile/user-12.jpg"
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="assets/images/profile/user-2.jpg" alt="modernize-img" class="img-fluid rounded-circle mb-4"
                    width="80" height="80">
                  <h4 class="card-title">Leo Pratt</h4>
                  <div class="d-flex align-items-center gap-4 mb-4">
                    <div class="d-flex align-items-center">
                      <a href="javascript:void(0)">
                        <img src="assets/images/profile/user-11.jpg"
                          class="rounded-circle me-n2 card-hover border border-white" width="32" height="32">
                      </a>
                      <a href="javascript:void(0)">
                        <img src="assets/images/profile/user-2.jpg"
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="img-fluid rounded-circle mb-4"
                    width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="assets/images/profile/user-4.jpg" alt="modernize-img" class="img-fluid rounded-circle mb-4"
                    width="80" height="80">
            ...
            <div class="col-md-4">
              <div class="card hover-img">
                <div class="card-body p-4 text-center border-bottom">
                  <img src="assets/images/profile/user-5.jpg" alt="modernize-img" class="rounded-circle mb-3" width="80"
                    height="80">
                  <h4 class="card-title mb-1">Betty Adams</h4>
            ...
            <div class="col-md-4">
              <div class="card hover-img">
                <div class="card-body p-4 text-center border-bottom">
                  <img src="assets/images/profile/user-2.jpg" alt="modernize-img" class="rounded-circle mb-3" width="80"
                    height="80">
                  <h4 class="card-title mb-1">Leo Pratt</h4>
            ...
            <div class="col-md-4">
              <div class="card hover-img">
                <div class="card-body p-4 text-center border-bottom">
                  <img src="assets/images/profile/user-3.jpg" alt="modernize-img" class="rounded-circle mb-3" width="80"
                    height="80">
                  <h4 class="card-title mb-1">Charles Nunez</h4>
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <img src="assets/images/products/s1.jpg" alt="modernize-img"
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          ...
                          <img src="assets/images/svgs/icon-paypal.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          ...
                          <img src="assets/images/svgs/icon-office-bag.svg" alt="modernize-img" class="img-fluid"
                            width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          ...
                          <img src="assets/images/svgs/icon-master-card.svg" alt="modernize-img" class="img-fluid"
                            width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-7 pb-8">
                      <div class="d-flex">
                        <div
                          ...
                          <img src="assets/images/svgs/icon-pie.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
                  ...
                  <div class="position-relative">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          class="p-8 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="assets/images/svgs/icon-map-pin.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-info-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="assets/images/svgs/icon-database.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          class="p-8 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="assets/images/svgs/icon-phone.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div
                          class="p-8 bg-danger-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="assets/images/svgs/icon-screen-share.svg" alt="modernize-img" class="img-fluid"
                            width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex flex-shrink-0">
                        <div
                          class="p-8 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="assets/images/svgs/icon-mail.svg" alt="modernize-img" class="img-fluid" width="24"
                            height="24">
                        </div>
                        <div>
