...
<body class="link-sidebar">
  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="UI Card"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <!-- Row -->
          <div class="row">
            <div class="col-12">
              <!-- 1. card with img -->
    ...
    &lt;/div&gt;
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                <img src="assets/images/blog/blog-img5.jpg" class="card-img-top" alt="modernize-img" />
                <div class="card-body p-10">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                <img src="assets/images/blog/blog-img8.jpg" class="card-img-top" alt="modernize-img" />
                <div class="card-body p-10">
                  <h5 class="card-title fs-5">Samuel Eliza</h5>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
