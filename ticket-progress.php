    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="checkout"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <div class="checkout">
            <div class="card">
                ...
                <div class="wizard-content">
                  <form action="#" class="tab-wizard wizard-circle">
                            ...
                            <tr>
                              <td class="border-bottom-0">
                                <div class="d-flex align-items-center gap-3 overflow-hidden">
                                  <img src="assets/images/products/s11.jpg" alt="matdash-img" class="img-fluid rounded"
                                    width="80">
                                  <div>
                              ...
                              <td class="border-bottom-0">
                                <div class="input-group input-group-sm flex-nowrap rounded">
                                  <button class="btn minus min-width-40 py-0 border-end border-muted border-end-0 text-muted"
                                  ...
                                  <button class="btn min-width-40 py-0 border border-muted border-start-0 text-muted add"
                          ...
                          <div class="card-body p-4">
                            ...
                            <div class="btn-group flex-row gap-3 w-100" role="group" aria-label="Basic radio toggle button group">
                              <div class="position-relative form-check btn-custom-fill flex-fill ps-0">
                                <input type="radio" class="form-check-input ms-4 round-16" name="deliveryOpt1" id="btnradio1"
                              ...
                              <div class="position-relative form-check btn-custom-fill flex-fill ps-0">
                                <input type="radio" class="form-check-input ms-4 round-16" name="deliveryOpt1" id="btnradio2"
                                  autocomplete="off">
                              ...
                              <div class="col-lg-8">
                                <div class="btn-group flex-column" role="group" aria-label="Basic radio toggle button group">
                                  <div class="position-relative mb-3 w-100 form-check btn-custom-fill ps-0">
                                    ...
                                    <input type="radio" class="form-check-input ms-4 round-16" name="paymentType1" id="btnradio3"
                                      autocomplete="off" checked>
                                  ...
                                  <div class="position-relative mb-3 form-check btn-custom-fill ps-0">
                                    <input type="radio" class="form-check-input ms-4 round-16" name="paymentType1" id="btnradio4"
                                      autocomplete="off">
                                  ...
                                  <div class="position-relative form-check btn-custom-fill ps-0">
                                    <input type="radio" class="form-check-input ms-4 round-16" name="paymentType1" id="btnradio5"
                                      autocomplete="off">
                    ...
                    <section class="payment-method text-center">
                      ...
                      <img src="assets/images/products/payment-complete.svg" alt="matdash-img" class="img-fluid mb-4"
                        width="350">
                      <p class="mb-0 fs-2">We will send you a notification<br>within 2 days when it ships.</p>
                      <div class="d-sm-flex align-items-center justify-content-between my-4">
                        <a href="eco-shop.php" class="btn btn-success d-block mb-2 mb-sm-0">Continue Shopping</a>
