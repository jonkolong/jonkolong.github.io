...
<nav class="navbar navbar-expand-lg p-0">
  ...
  <ul class="navbar-nav quick-links d-none d-lg-flex align-items-center">
    ...
    <li class="nav-item dropdown-hover d-none d-lg-block">
      <a class="nav-link" href="app-calendar.php">Kalender</a>
    </li>
    <li class="nav-item dropdown-hover d-none d-lg-block">
      <a class="nav-link" href="app-notes.php">Catatan</a>
    </li>
  </ul>
...
<!-- ------------------------------- -->
<?php include("partials/header-components/dd-apps-mobile.php"); ?>