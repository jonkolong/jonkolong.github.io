    ...
    <li class="nav-item nav-icon-hover-bg rounded w-auto dropdown d-none d-lg-flex">
      <div class="hover-dd">
        ...
        <div class="dropdown-menu dropdown-menu-nav dropdown-menu-animate-up py-0">
          <?php include("partials/header-components/dd-apps.php"); ?>
        </div>
      </div>
    </li>
    <!-- ------------------------------- -->
      ...
      <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
        ...
        <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="assets/images/svgs/icon-flag-cn.svg" alt="modernize-img" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="assets/images/svgs/icon-flag-fr.svg" alt="modernize-img" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="assets/images/svgs/icon-flag-sa.svg" alt="modernize-img" width="20px" height="20px"
                    class="rounded-circle object-fit-cover round-20" />
                </div>
        ...
        <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
          ...
          <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <?php include("partials/header-components/dd-notification.php"); ?>
          </div>
        </li>
        <!-- ------------------------------- -->
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
            <?php include("partials/header-components/dd-profile.php"); ?>
          </div>
        </li>
        <!-- ------------------------------- -->
