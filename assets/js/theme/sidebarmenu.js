...
if ((at = "vertical")) {
  ...
  if (currentNewURL.includes("/main/index.php")) {
    current_link.setAttribute("href", "./main/index.php");
  } else if (currentNewURL.includes("/index.php")) {
    current_link.setAttribute("href", "./index.php");
  } else {
