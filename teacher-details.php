    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Teacher details"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <div class="row">
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="text-center">
                    <img src="assets/images/profile/user-2.jpg" width="110" class="rounded-3 mb-3" alt="modernize-img" />
