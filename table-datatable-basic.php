    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Datatable Basic"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
                  ...
                  <table id="zero_config"
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-6">
                            <img src="assets/images/profile/user-7.jpg" width="45"
                              class="rounded-circle" />
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-6">
                            <img src="assets/images/profile/user-8.jpg" width="45"
                              class="rounded-circle" />
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-6">
                            <img src="assets/images/profile/user-9.jpg" width="45"
                              class="rounded-circle" />
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-6">
                            <img src="assets/images/profile/user-10.jpg" width="45"
                              class="rounded-circle" />
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-6">
                            <img src="assets/images/profile/user-11.jpg" width="45"
                              class="rounded-circle" />
