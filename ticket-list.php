    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Shop list"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
                  ...
                  <table class="table align-middle text-nowrap mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/products/s1.jpg" class="rounded-circle" alt="modernize-img"
                              width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/products/s2.jpg" class="rounded-circle" alt="modernize-img"
                              width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/products/s3.jpg" class="rounded-circle" alt="modernize-img"
                              width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/products/s4.jpg" class="rounded-circle" alt="modernize-img"
                              width="56" height="56">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center">
                            <img src="assets/images/products/s5.jpg" class="rounded-circle" alt="modernize-img"
                              width="56" height="56">
                            <div class="ms-3">
