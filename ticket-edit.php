    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Edit Product"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          ...
          <div class="row">
                    ...
                    <table class="table mb-0 align-middle">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-11.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-8.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-3.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-4.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-5.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-6.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-7.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="assets/images/profile/user-10.jpg" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
            ...
            <div class="col-lg-4">
              <div class="offcanvas-lg offcanvas-end overflow-auto" tabindex="-1" id="offcanvasRight"
