    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
          <?PHP $title="Modals"; $subtitle= "Home"; include("partials/breadcrumb.php"); ?>
          <div class="row">
            <div class="col-12">
              <!-- start Modal Sizes -->
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-md-flex button-group">
                    <div>
                      ...
                      <!-- Extra Large -->
                      <!-- ------------------------------------------ -->
                      <button class="btn me-1 mb-1 bg-warning-subtle text-warning px-4 fs-4 " data-bs-toggle="modal"
                    ...
                    <div>
                      ...
                      <!-- Small -->
                      <!-- ------------------------------------------ -->
                      <button class="btn me-1 mb-1 bg-danger-subtle text-danger px-4 fs-4 " data-bs-toggle="modal"
                ...
                <div class="card-body">
                  ...
                  <div class="button-group">
                    ...
                    <button type="button" class="btn mb-1 bg-warning-subtle text-warning px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#scroll-long-outer-modal">
                      Scroll Long Outer Modal
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="scroll-long-outer-modal" data-bs-backdrop="static"
                      data-bs-keyboard="false" tabindex="-1" aria-labelledby="scroll-long-outer-modal"
                      aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                          <div class="modal-header d-flex align-items-center">
                    ...
                    <button type="button" class="btn mb-1 bg-success-subtle text-success px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#scroll-long-inner-modal">
                      Scroll Long Inner Modal
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="scroll-long-inner-modal" data-bs-backdrop="static"
                    ...
                    <button type="button" class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#with-grid-modal">
                      With Grid Modal
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="with-grid-modal" tabindex="-1" aria-labelledby="scroll-long-inner-modal"
                      aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                          <div class="modal-header d-flex align-items-center">
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn mb-1 bg-primary-subtle text-primary px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#pop-tool-modal">
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>
                              This
                              <a href="javascript:void(0)" role="button" class="btn btn-secondary popover-test" title="Popover title"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                    ...
                    <button type="button" class="btn mb-1 px-4 fs-4  bg-success-subtle text-success"
                      data-bs-toggle="modal" data-bs-target="#samedata-modal" data-bs-whatever="@fat">
                      Open modal for @fat
                    </button>

                    <button type="button" class="btn mb-1 px-4 fs-4  bg-warning-subtle text-warning"
                      data-bs-toggle="modal" data-bs-target="#samedata-modal" data-bs-whatever="@getbootstrap">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                          ...
                          <div class="modal-body">
                            <div class="text-center mt-2 mb-4">
                              <a href="index.php" class="text-success">
                                <span>
                                  <img src="assets/images/logos/favicon.png" class="me-3 img-fluid"
                                    alt="modernize-img" />
                                </span>
                              </a>
                            </div>
                      ...
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                          <div class="modal-body">
                            <div class="text-center mt-2 mb-4">
                              <a href="index.php" class="text-success">
                                <span><img src="assets/images/logos/favicon.png" class="me-3 img-fluid"
                                    alt="modernize-img" />
                                </span>
                              </a>
                            </div>
                    ...
                    <!-- /.modal -->
                    <!-- Full width modal -->
                    <button type="button" class="btn bg-warning-subtle text-warning px-4 fs-4 " data-bs-toggle="modal"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                    ...
                    <!-- Fullscreen -->
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-primary-subtle text-primary px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen">
                      Fullscreen Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen" tabindex="-1" aria-labelledby="bs-example-modal-lg"
                      aria-hidden="true">
                    ...
                    <!-- Fullscreen -->
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-success-subtle text-success px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen-down-sm">
                      Fullscreen Below sm Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen-down-sm" tabindex="-1"
                      aria-labelledby="bs-example-modal-lg" aria-hidden="true">
                    ...
                    <!-- Fullscreen -->
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-warning-subtle text-warning px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen-down-md">
                      Fullscreen Below md Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen-down-md" tabindex="-1"
                      aria-labelledby="bs-example-modal-lg" aria-hidden="true">
                    ...
                    <!-- Fullscreen -->
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen-down-lg">
                      Fullscreen Below lg Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen-down-lg" tabindex="-1"
                      aria-labelledby="bs-example-modal-lg" aria-hidden="true">
                    ...
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-success-subtle text-success px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen-down-xl">
                      Fullscreen Below xl Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen-down-xl" tabindex="-1"
                    ...
                    <!-- ------------------------------------------ -->
                    <button class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bs-fullscreen-down-xxl">
                      Fullscreen Below xxl Modal
                    </button>
                    <div class="modal fade" id="bs-fullscreen-down-xxl" tabindex="-1"
                      aria-labelledby="bs-example-modal-xxl" aria-hidden="true">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                    ...
                    <!-- /.modal -->
                    <!-- info header modal -->
                    <button type="button" class="btn mb-1 bg-info-subtle text-info px-4 fs-4 " data-bs-toggle="modal"
                    ...
                    <button type="button" class="btn mb-1 bg-warning-subtle text-warning px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#warning-header-modal">
                      Warning Header
                    </button>
                    <!-- warning Header Modal -->
                    <div id="warning-header-modal" class="modal fade" tabindex="-1"
                    ...
                    <!-- /.modal -->
                    <!-- dark header modal -->
                    <button type="button" class="btn mb-1 btn-dark px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#dark-header-modal">
                      Dark Header
                    </button>
                    <!-- dark Header Modal -->
                    <div id="dark-header-modal" class="modal fade" tabindex="-1"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                    <!-- Primary header modal -->
                    <button type="button" class="btn mb-1 bg-primary-subtle text-primary px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#bg-primary-header-modal">
                      Primary Modal
                    </button>
                    <!-- Primary Header Modal -->
                    ...
                    <!-- info header modal -->
                    <button type="button" class="btn mb-1 bg-info-subtle text-info px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bg-info-header-modal">
                      Info Modal
                    </button>
                    <!-- info Header Modal -->
                    ...
                    <!-- danger header modal -->
                    <button type="button" class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#bg-danger-header-modal">
                      Danger Modal
                    </button>
                    <!-- danger Header Modal -->
                    <div id="bg-danger-header-modal" class="modal fade" tabindex="-1"
                      aria-labelledby="danger-header-modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    ...
                    <!-- warning header modal -->
                    <button type="button" class="btn mb-1 bg-warning-subtle text-warning px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#bg-warning-header-modal">
                      Warning Modal
                    </button>
                    <!-- warning Header Modal -->
                    <div id="bg-warning-header-modal" class="modal fade" tabindex="-1"
                      aria-labelledby="warning-header-modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    ...
                    <!-- success header modal -->
                    <button type="button" class="btn mb-1 bg-success-subtle text-success px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#bg-success-header-modal">
                      Success Modal
                    </button>
                    <!-- success Header Modal -->
                    <div id="bg-success-header-modal" class="modal fade" tabindex="-1"
                      aria-labelledby="success-header-modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    ...
                    <!-- dark header modal -->
                    <button type="button" class="btn mb-1 btn-dark px-4 fs-4 " data-bs-toggle="modal"
                      data-bs-target="#bg-dark-header-modal">
                      Dark Modal
                    </button>
                    <!-- dark Header Modal -->
                    <div id="bg-dark-header-modal" class="modal fade" tabindex="-1"
                      aria-labelledby="dark-header-modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="button-group">
                    <!-- Button trigger modal -->
                    <button type="button" class="btn mb-1 bg-success-subtle text-success  px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#al-success-alert">
                      Success Alert
                    </button>
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn mb-1 bg-warning-subtle text-warning  px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#al-warning-alert">
                      Warning Alert
                    </button>
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn mb-1 bg-danger-subtle text-danger  px-4 fs-4 "
                      data-bs-toggle="modal" data-bs-target="#al-danger-alert">
                      Danger Alert
                    </button>
